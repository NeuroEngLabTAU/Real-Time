...
from stg._wrapper.constants import STG4002_specification, OUTPUT_RATE_in_Hz, STG5_specification
...
from stg._wrapper.downloadnet import STG5 as STG5DL
...
class STG4000Streamer(STG4000DL):
    ...
    _outputrate: int = STG4002_specification[OUTPUT_RATE_in_Hz]
...
class STG5Streamer(STG5DL):
    """
    STG5Streamer class with methods inherited from STG4000Streamer.
    """

    _streaming = STG4000Streamer._streaming
    _signals = STG4000Streamer._signals
    _outputrate = STG5_specification[OUTPUT_RATE_in_Hz]

    # Inherit methods from STG4000Streamer
    _stream = STG4000Streamer._stream
    start_streaming = STG4000Streamer.start_streaming
    stop_streaming = STG4000Streamer.stop_streaming
    set_signal = STG4000Streamer.set_signal
    streamer = STG4000Streamer.streamer
