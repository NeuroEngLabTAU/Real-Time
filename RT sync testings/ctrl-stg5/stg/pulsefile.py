...
from stg._wrapper.constants import OUTPUT_RATE_in_Hz, STG5_specification, STG4002_specification
...
def decompress(
    ...
    """
    if rate_in_hz not in [10_000, STG4002_specification[OUTPUT_RATE_in_Hz], STG5_specification[OUTPUT_RATE_in_Hz]]:
