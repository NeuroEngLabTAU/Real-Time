...
if __name__ == '__main__':
    ...
    # try:
    #     # Adjust this to match the strea                     m from 'experiment_waldo_intensity.py'
    #     streams = resolve_stream('name', 'Trigger_Cog')  # Resolving by stream name
    #     global lsl_inlet
